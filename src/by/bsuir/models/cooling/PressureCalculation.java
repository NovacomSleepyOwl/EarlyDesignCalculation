...
public class PressureCalculation {
    ...
    public static double[][] perforated = new double[10][2];
    ...
    private static void setEqualHermetic() {
    ...
    private static void setUnequalHermetic(double internalPressure){
    ...
    private static void setHermeticBlownOn(int w){
    ...
    private static void setHermeticMixedAir(int w){
    ...
    private static void setPerforated(){
